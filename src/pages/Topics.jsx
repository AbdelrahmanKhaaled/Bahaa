      ...
      <div className="max-w-[1440px] mx-auto px-[100px] py-16 pt-[180px]">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-cyan text-[20px] font-salsa capitalize">choose your topic</span>
          </div>
          <h1 className="text-[48px] font-bold text-gray-text mb-4">
        ...
        {/* Search Form */}
        <div className="bg-white rounded-[27.928px] shadow-[0px_0px_41.333px_0px_rgba(35,62,121,0.15)] p-[41.89px] mb-16">
          <div className="flex items-end gap-[27.93px]">
            {/* Choose Grade */}
            <div className="flex-1">
              <label className="block text-[24px] font-salsa capitalize text-dark-blue mb-[16.76px]">
                Choose Grade
              </label>
              <div className="relative">
                <select className="w-full px-[27.93px] py-[41.89px] bg-gray-bg rounded-[13.964px] appearance-none text-[22px] font-salsa text-gray-text h-[83.784px] border-none focus:outline-none">
                  <option>Grade 5</option>
                </select>
                <div className="absolute right-[20.95px] top-1/2 -translate-y-1/2 pointer-events-none">
                  <svg className="w-[13.964px] h-[8.378px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Vertical Divider */}
            <div className="w-[1.396px] h-[150.811px] bg-gray-divider"></div>
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <div className="absolute right-[20.6px] top-1/2 -translate-y-1/2 pointer-events-none">
                  <svg className="w-[13.964px] h-[8.378px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </div>
            ...
            {/* Search Button */}
            <button className="w-[69.82px] h-[69.82px] bg-dark-blue text-white rounded-[34.91px] flex items-center justify-center hover:opacity-90 transition-opacity">
              <svg className="w-[23.739px] h-[16.757px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div className="flex gap-10">
                ...
                return (
                  <div key={index} className="relative">
                    <button
                      ...
                      className={`w-full border-2 rounded-[28px] p-5 flex items-center justify-between transition-colors ${
                        isExpanded 
                          ? 'bg-[#243e7a] border-[#243e7a]' 
                          : 'bg-white border-[#dfdfdf]'
                      }`}
                    >
                      <span className={`text-[20px] font-salsa ${isExpanded ? 'text-white' : 'text-[#243e7a]'}`}>
                        {item.title}
                      </span>
                      <svg 
                        className={`w-8 h-8 transition-transform ${isExpanded ? 'rotate-180' : ''} ${isExpanded ? 'text-white' : 'text-gray-500'}`}
                        fill="none" 
                        stroke="currentColor" 
                        viewBox="0 0 24 24"
                      >
                    ...
                    {isExpanded && (
                      <div className="absolute top-[64px] left-[18px] bg-[#f4f5f8] rounded-[28px] p-5 w-[715px] z-10">
                        <p className="text-[20px] text-[#7e7e7e] font-salsa mb-4 leading-[24px]">
                          {item.content}
                        </p>
            ...
            <div className="w-[447px] h-[243px] bg-gradient-to-br from-blue-200 to-blue-300 rounded-2xl flex items-center justify-center flex-shrink-0">
